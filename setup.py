...
plugin_identifier = "survey"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_survey"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Survey"
...
# module
plugin_description = """Display an embedded google form on octoprint events."""
...
plugin_url = "https://github.com/voxel8/OctoPrint-Survey"
